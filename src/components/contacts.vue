    ...
    <div class="contact-bg font1 bggreen3">
      ...
      <div class="mob-width">
              ...
              <div class="mb-4 mx-1 position-relative input-width w-35">
                ...
                <div class="userpostion">
                  <svg
                    ...
                    style="enable-background: new 0 0 480.804 480.804"
                    xml:space="preserve"
                  >
                    <g>
                      <g>
                        <g>
                          <path
                            d="M338.352,356.372c-0.984-0.536-3.118-1.704-6.024-3.334c-9.496-5.245-17.814-10.355-24.29-14.864
				...
				c25.456,8.064,59.721,23.257,78.396,49.836c10.718,15.254,11.344,27.458,11.368,28.096v17.418H57.902z"
                          />
                          <path
                            d="M247.902,183.303h-15v40c0,4.143,3.358,7.5,7.5,7.5h20v-15h-12.5V183.303z"
                          />
                        </g>
                      </g>
                    </g>
              ...
              <div class="my-4 position-relative input-width w-35">
                <div class="atpostion">
                  ...
                  <svg
                    ...
                    width="30px"
                    fill="white"
                    viewBox="0 0 205.996 205.996"
                    style="enable-background: new 0 0 205.996 205.996"
                    xml:space="preserve"
                  >
                    <g>
                      <path
                        d="M102.996,61.363c22.958,0,41.635,18.678,41.635,41.635c0,3.313,2.687,6,6,6s6-2.687,6-6
		...
		c-7.448,12.745-21.233,20.662-35.976,20.662c-22.958,0-41.635-18.678-41.635-41.635S80.038,61.363,102.996,61.363z"
                      />
                      <path
                        d="M205.698,95.053c-3.76-50.059-44.326-90.782-94.359-94.727C81.095-2.059,51.51,8.817,30.163,30.165
