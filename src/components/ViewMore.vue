<template>
  <div class="bgwhite position-relative">
    ...
    <div class="font1 context container">
      <div>
        <!-- intro text -->
        <u>
          ...
          <div class="row">
            ...
            >
              <div class="hov">
                ...
                <!-- link -->
                <div class="bggreen2 container-radius-link p-2 white">
...
<script>
import moreProjects from "@/json/projects.json";
export default {
  data() {
    return {
