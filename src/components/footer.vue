        ...
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div>
            <router-link to="/" class="text-decoration-none text-reset">
              <h4 class="logo-style reduce-logo acquirefontbold anima-nav">
                Jesutobi.
                <br />
                Joseph
              </h4>
          ...
          <div class="d-flex align-items-center">
            <!-- instagra, -->
            <a href="https://www.instagram.com/jesutobbi/" class="anima-nav">
              <div>
            ...
            <!-- git hub -->
            <a href="https://github.com/jesutobi" class="anima-nav">
              <div>
                <span class="">
            ...
            <!-- email -->
            <a href="mailto:jesutobit@gmail.com" class="anima-nav">
              <div>
                <span class="mx-2">
                  <svg
                    width="24px"
